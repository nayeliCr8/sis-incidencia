...
const form = useForm({
  ...
  observacion: props.equipo.observacion,
  tipo: props.equipo.tipo_equipo,
  oficina: props.equipo.oficina_id,
});

const save = () => {
  form.put(route("admin.equipos.update", props.equipo.id),{
        marca: form.marca,
        serie: form.serie,
        ip: form.ip,
        estado: form.estado,
          ...
          >
            <div class="p-4">
              ...
              <div class="mb-6">
                ...
                <InputError class="mt-2" :message="$page.props.errors.estado" />
              </div>
              <div class="mb-6">
              ...
              <div class="mb-6">
                ...
                <InputError class="mt-2" :message="$page.props.errors.tipo" />
              </div>
              <div class="mb-6">
                ...
                <InputError class="mt-2" :message="$page.props.errors.oficina" />
              </div>
              <!-- <div class="mb-6">
                <InputLabel>Oficina</InputLabel>
                  <VueMultiselect 
