...
class OficinaPolicy
{
    ...
    {
        return $user->hasPermissionTo('oficina index') ? true : false;
    }
    ...
    {
        return $user->hasPermissionTo('oficina create') ? true : false;
    }
    ...
    {
        return $user->hasPermissionTo('oficina update') ? true : false;
    }
    ...
    {
        return $user->hasPermissionTo('oficina delete') ? true : false;
    }
